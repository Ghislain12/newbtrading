...
<div class="flex flex-col min-h-screen py-12 sm:px-6 lg:px-48">
    <div class="w-full lg:flex">
        <div class="p-16 rounded-tl rounded-tr xl:w-2/5 lg:w-2/5 xl:rounded-bl xl:rounded-tr-none bg-red-600"
                    ...
                    <div class="w-2/4 max-w-xs xl:flex xl:justify-end">
                        <div class="flex flex-col">
                            ...
                            <input id="email" name="email" type="email" wire:model='email'
                                class="flex items-center w-64 h-10 pl-3 text-sm font-normal border border-gray-300 rounded dark:bg-gray-900 dark:text-white dark:border-gray-700 focus:outline-none focus:border focus:border-red-600"
                ...
                <div class="w-full mt-6">
                    <div class="flex flex-col">
                        ...
                        <textarea placeholder="" name="message" wire:model='content'
                            class="px-3 py-2 mb-4 text-sm border border-gray-300 rounded outline-none resize-none dark:bg-gray-900 dark:text-white dark:border-gray-700 focus:border focus:border-red-600"
                    ...
                    <button type="submit" wire:submit='send'
                        class="px-8 py-3 text-sm leading-6 text-white bg-red-600 rounded focus:border-4 focus:ring-offset-2 hover:bg-orange-500 hover:shadow-lg focus:bg-orange-500 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-orange-500 active:shadow-lg transition duration-150 ease-in-out">Submit</button>
                </div>
            </form>
        </div>
    </div>
